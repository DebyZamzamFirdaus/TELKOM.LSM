    ...
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <div class="text-end">
        <div class="dropdown"> <a href="https://getbootstrap-com.translate.goog/docs/5.2/examples/sidebars/?_x_tr_sl=en&amp;_x_tr_tl=id&amp;_x_tr_hl=id&amp;_x_tr_pto=sc#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> <img src="https://github.com/mdo.png" alt="" width="32" height="32" class="rounded-circle me-2"> <strong>username</strong> </a> 
          <ul class="dropdown-menu text-small shadow">  <li><a class="dropdown-item" href="https://getbootstrap-com.translate.goog/docs/5.2/examples/sidebars/?_x_tr_sl=en&amp;_x_tr_tl=id&amp;_x_tr_hl=id&amp;_x_tr_pto=sc#">Settings</a></li> 
  ...
  <div class="container marketing">
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        ...
        <p><a class="btn btn-outline-danger" href="driver.php">Lihat Selengkapnya &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-6">
        <img src="img/IMG7..png" class="img-circle" alt="Gambar" width="270" height="180">
        ...
        <p><a class="btn btn-outline-danger" href="client.php">Lihat Selengkapnya &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-6">
        ...
        <p>Another exciting bit of representative placeholder content. This time, we've moved on to the second column.</p>
        <p><a class="btn btn-outline-danger" href="admin.php">Lihat Selengkapnya &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-6">
        <img src="img/IMG5..png" class="img-circle" alt="Gambar" width="270" height="180">

        <h2 class="fw-normal">INFO</h2>
        <p>Another exciting bit of representative placeholder content. This time, we've moved on to the second column.</p>
        <p><a class="btn btn-outline-danger" href="info.php">Lihat Selengkapnya &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
</div>
