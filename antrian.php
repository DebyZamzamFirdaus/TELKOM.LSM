...
<body>
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="#" class="nav-link text-white">Berita</a></li>
          <li><a href="#" class="nav-link text-white">About</a></li>
          <li><a href="#" class="nav-link text-white">Kontak</a></li>
        </ul>
        ...
        <div class="text-end">
          ...
          <button type="button" class="btn btn-outline-secondary"><a href="sign.php">Sign-up</a></button>
        </div>
      </div>
    </div>
  </header>
  ...
  <main>
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading fw-normal lh-1">ANTRIAN<span class="text-muted"></span></h2>
        <p class="lead">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
        ...
        <p class="lead">Klik Mulai Untuk Mulai Mengantri</p>
        <p><a class="btn btn-outline-primary" href="sign.php">MULAI &raquo;</a></p>
      </div>
      <div class="col-md-5">
        <br><br><br><br><br>
        <img src="img/img3.png" class="img-circle" alt="Gambar informasi" width="400" height="250">
      </div>
    </div>
