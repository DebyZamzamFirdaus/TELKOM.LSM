...
<body>
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="about.php" class="nav-link px-2 text-muted">About</a></li>
  ...
  <main>
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading fw-normal lh-1">About <span class="text-muted"></span></h2><br>
      ...
      <div class="col-md-5">
        <br><br>
        <img src="img/IMG2.jpg" class="img-circle" alt="Gambar informasi" width="400" height="250">
      </div>
    </div>
