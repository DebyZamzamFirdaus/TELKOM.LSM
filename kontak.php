...
<body>
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="kontak.php" class="nav-link px-2 text-muted">Kontak</a></li>
        </ul>
  ...
  <main>
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading fw-normal lh-1">Kontak<span class="text-muted"></span></h2><br>
        <p class="lead">Anda bisa menghubungi kami melalui kontak yang disediakan di bawah ini. Semua pesan yang Anda kirimkan akan diproses. Terimakasih.</p>
        <p>WA    : 0895606602371</p>
        <p>EMAIL : debyzamzamfirdaus@gmail.com</p>
        <!-- <p><a class="btn btn-outline-primary" href="#">Lihat Selengkapnya &raquo;</a></p> -->
      </div>
      <div class="col-md-5">
        <br><br>
        <img src="img/IMG3.jpg" class="img-circle" alt="Gambar informasi" width="400" height="250">
      </div>
    </div>
