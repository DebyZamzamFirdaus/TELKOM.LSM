...
<?php
    include "koneksi.php";
    $nik = $_GET['nik'];
    $data = mysqli_query($conn, "select * from proses_info where nik='$nik'");
    while($d = mysqli_fetch_array($data)){
    ?>
    <div class="container">
        <div class="col-10 m-auto" style="padding: 100px 0 0 0;">
            <h2 class="text-center fw-bold">Edit Data Info</h2>
        <div class="col-md-8 m-auto card p-5 shadow p-3 mb-5 bg-body rounded">
            <div class="bs-example">
            <form action="proses/edit_info.php" method="POST">
